<%@ Page Title="" Language="C#" MasterPageFile="~/EmployManagementSystem.Master" AutoEventWireup="true" CodeBehind="UpdateEmploy.aspx.cs" Inherits="EMSWebApp.UpdateEmploy" %>
    ...
    <table cellpadding="6" cellspacing="6" style="width: 100%; border: 3px solid #3399FF">
        ...
        <tr>
            <td colspan="2">
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Button ID="btnAdd" runat="server"  Text="Update Employ" OnClick="btnAdd_Click" />
                &nbsp;</td>
        </tr>
    </table>
</asp:Content>
